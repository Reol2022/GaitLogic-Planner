...
| EXPLAIN | EXPLAIN_RUNNER_STATE | SUCCEEDED | SUCCEEDED | 4 | 是 |
| TODAY | TODAY_RECOMMENDATION | SUCCEEDED | SUCCEEDED | 1 | 是 |
...
| EMPTY_RETRIEVAL | GENERAL_TRAINING_QUESTION | DEGRADED | FAILED | 0 | 是 |
