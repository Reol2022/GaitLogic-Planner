...
def test_release_documents_declare_current_version_and_preserve_v0150_history() -> None:
    ...
    release_notes = (PROJECT_ROOT / "docs" / "release" / "v0.16.0.md").read_text(encoding="utf-8")

    assert "v0.16.0" in readme
    assert "v0.16.0" in readme_en
    assert "## v0.16.0" in changelog
    assert "# GaitLogic Planner v0.16.0" in release_notes
