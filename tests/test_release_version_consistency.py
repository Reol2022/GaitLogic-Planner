...
def test_release_documents_declare_current_version_and_preserve_v0140_history() -> None:
    ...
    release_notes = (PROJECT_ROOT / "docs" / "release" / "v0.15.0.md").read_text(encoding="utf-8")

    assert "v0.15.0" in readme
    assert "v0.15.0" in readme_en
    assert "## v0.15.0" in changelog
    assert "# GaitLogic v0.15.0" in release_notes
